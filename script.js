function changeBoxContent(item) {
    ...
    switch (item.id) {
        case 'home':
            colorBox.innerHTML = "<h1>Home</h1><p>Welcome to our gaming world!</p>";
            break;
        case 'about':
            colorBox.innerHTML = "<h1>About</h1><p>Learn more about our gaming platform.</p>";
            break;
        case 'services':
            colorBox.innerHTML = "<h1>Services</h1><p>Explore our gaming services.</p>";
            break;
        case 'contact':
            colorBox.innerHTML = "<h1>Contact</h1><p>Get in touch with us.</p>";
            break;
        default:
            colorBox.innerHTML = "<h1>Color-Changing Box</h1><p>Explore the gaming universe with us!</p><p>Level up your gaming experience.</p>";
    }
